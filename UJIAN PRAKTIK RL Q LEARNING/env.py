...
class Environment(tk.Tk, object):
    ...
    def build_environment(self):
        ...
        # Obstacle 11
        self.obstacle11 = self.canvas_widget.create_image(pixels * 6, pixels * 7, anchor='nw', image=self.obstacle4_object)
        # Obstacle 12
        ...
        self.obstacle22 = self.canvas_widget.create_image(pixels * 2, pixels * 3, anchor='nw', image=self.obstacle2_object)
         # Obstacle 23
        self.obstacle23 = self.canvas_widget.create_image(pixels * 2, pixels * 6, anchor='nw', image=self.obstacle10_object)

        # Final Point
        img_flag = Image.open("images/flag.png")
        self.flag_object = ImageTk.PhotoImage(img_flag)
        self.flag = self.canvas_widget.create_image(pixels * 5, pixels * 6, anchor='nw', image=self.flag_object)
